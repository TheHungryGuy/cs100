...
def litCricFriend(wordList, text):
    ...
    lcfListStripped = []
    for word in lcfList:
        lcfListStripped.append(word.strip(string.punctuation))
    ...
    for word in wordList:
        for stripWord in lcfListStripped:
            if word.lower() == stripWord:
                countWords += 1;
    ...
    return countWords/len(lcfListStripped)
...
print("The Bells \"a\" & \"an\" freqency is ",litCricFriend(['a','an'],theBells))
print("The Bells \"the\" freqency is ",litCricFriend(['the'],theBells))
print("Canto XII \"a\" & \"an\" freqency is ",litCricFriend(['a','an'],cantoXII))
print("Canto XII \"the\" freqency is ",litCricFriend(['the'],cantoXII))
...
Yes the results show that poe uses "a" & " an" more frequently than neruda.
Poe also uses 'the' more ofthen than neruda.
'''